...
public class SkinStoreScreen extends Screen {
      ...
      */
     public SkinStoreScreen(final GameState gameState, final int width, final int height, final int fps) {
     ...
     private void nextMenuItem() {
         if (this.returnCode == 11)
             this.returnCode = 9; //화면 넣을 순서 정해지면 변경
         else
             this.returnCode = 11;
     }
     ...
     private void previousMenuItem() {
         if (this.returnCode == 11)
             this.returnCode = 3; //화면 넣을 순서 정해지면 변경
         else
             this.returnCode = 11;
     } 
